...
const cards = [
  {
    ...
    description:
      "Conectar sueños con destinos, brindando experiencias de viaje accesibles y seguras para todos nuestros clientes en Sudamérica.",
  },
  {
    icon: Eye,
    title: "Nuestra Visión",
    description:
      "Ser la agencia de turismo líder en la región, reconocida por nuestra innovación, transparencia y excelencia en el servicio al cliente.",
  },
];
