        ...
        <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} className="relative max-w-4xl mx-auto">
          ...
          <div className="relative vh-gradient-dark rounded-3xl p-12 md:p-16 text-center overflow-hidden">
            ...
            <div className="relative z-10">
              <h2 className="text-3xl md:text-5xl font-display font-black text-primary-foreground mb-4">{t("search.title")}</h2>
              <p className="text-primary-foreground/80 text-lg mb-8 max-w-xl mx-auto">{t("search.desc")}</p>
